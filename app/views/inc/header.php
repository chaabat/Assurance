...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
  ...
  <img class="w-8 h-8" src="../../public/photos/administrateur.png" alt="">
      ...
      <br>
         ...
         <li>
            <a href="<?php echo URLROOT;?>/pages/assurence" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
  ...
  <img class="w-8 h-8" src="../../public/photos/batiment.png" alt="">
         ...
         <li>
            <a href="<?php echo URLROOT;?>/pages/clients" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
