...
<button type="button"
    class="top-10 mb-8 ml-[260px] relative px-8 py-4 ml-4 overflow-hidden font-semibold  bg-[#fdba74]">Ajouter
</button>
<div class=" flex justify-evenly items-center ml-64 mb-8 p-[30px]">
    ...
    <table class="mt-4 w-full min-w-max table-auto text-left">
        <thead>
            <tr>
                <th
                    class="cursor-pointer border-y border-blue-gray-100 bg-[#fdba74] p-4 transition-colors hover:bg-blue-gray-50">
                    <p
