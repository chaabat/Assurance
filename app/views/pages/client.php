        ...
        <?php foreach($data as $user){ ?>
                        <tr>
                            ...
                            <td class="flex gap-[10px]">
                                <a href='<?=URL_ROOT?>/admin/deleteUser?id=<?= $user->addressID ?>&userId=<?= $user->userID?>' class='flex items-center justify-center bg-rose-500 text-white w-[40px] h-[40px]'>
                                    <i class='fa-solid fa-trash'></i>
                                </a>
                                <a href='<?=URL_ROOT?>/admin/editUser?id=<?= $user->userID ?>' class='flex items-center justify-center bg-green-500 text-white w-[40px] h-[40px]'>
            ...
            <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="pre&nom" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" >
                    </div>
                    <div class="col-span-2">
